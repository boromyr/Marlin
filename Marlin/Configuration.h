...
#define STRING_CONFIG_H_AUTHOR   "(boromyr)" // Who made the changes.
...
/**
  ...
  */
  ...
  #define Z_DRIVER_TYPE    TMC2208 // _STANDALONE
  #define E0_DRIVER_TYPE   A4988   // TMC2209_STANDALONE
#else
...
/**
  ...
  */
#define DEFAULT_AXIS_STEPS_PER_UNIT    { 79.92, 79.37, 397.79, 97.149 }
...
/**
  ...
  *     O-- FRONT --+
  */
#define NOZZLE_TO_PROBE_OFFSET            { -33, -5, -1.60 }
